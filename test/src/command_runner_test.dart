...
import 'package:tree_frog_cli/src/command_runner.dart';
...
void main() {
  group('TreeFrogCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late TreeFrogCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = TreeFrogCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = TreeFrogCliCommandRunner();
